...
<tr>
    ...
    <td width="81%"><label>
            <input name="frm_id_inmueble" type="text" id="frm_id_inmueble"
                   onblur="validacion_id_inmueble_usu(document.form1.frm_id_inmueble.value)" maxlength="10"/>
            <input name="frm_id_oculto" type="hidden" id="frm_id_oculto"
                   value="<?php echo $registros['id_inmueble']; ?>"/>
        </label></td>
</tr>
<tr>
    <td>
        <div align="left" class="Estilo3">Ciudad</div>
    </td>
    <td><label>
            <div align="left">
...
<tr>
    <td>
        <div align="left" class="Estilo3">Dirección</div>
    </td>
    <td><label>
            <div align="left">
                <input name="frm_nombre" type="text" id="frm_nombre"
                       onblur="validacion_id_inmueble_usu(document.form1.frm_id_inmueble.value)"/>
            </div>
        </label></td>
</tr>
<tr>
    <td>
        <div align="left" class="Estilo3">Tipo</div>
    </td>
    <td><label>
            <div align="left">
...
<tr>
    <td>
        <div align="left" class="Estilo3">Medio</div>
    </td>
    <td><label>
            <div align="left">
                <select name="select" id="select" onchange="combo();">
...
<tr>
    <td>
        <div align="left" class="Estilo3">Cantidad</div>
    </td>
    <td><label>
            <div align="left">
                Dormitorios
...
<tr>
    <td>
        <div align="left" class="Estilo3">Comentario</div>
    </td>
    <td><label>
            <div align="left">
...
<tr>
    ...
    <td><input name="frm_fecha" type="text" id="frm_fecha" size="20" disabled="disabled" value="<?php echo $fecha; ?>"/>
    </td>
</tr>
<tr>
    <td colspan="2"
        ...
        <div align="center">
            <table border="0" align="center" cellpadding="0" cellspacing="5">
                <tr>
                    <td><label>
                            <input name="<?php if ($id_inmueble == "") { ?>ingresar<?php } else { ?>modificar<?php } ?>"
                                   type="button" id="ingresar2"
                                   value="<?php if ($id_inmueble == "") { ?>Ingresar<?php } else { ?>Modificar<?php } ?>"
                                   onclick="validar()"/>
                        </label></td>
                    <?php
                    if ($id_inmueble != "") {
...
<table width="89%" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#0033FF">
    <tr bgcolor="#0e99b5">
        <td>
            <div align="center" class="Estilo1">Id Inmueble</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Ciudad</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Direcci&oacute;n</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Tipo</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Medio</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Cantidad Dormitorio</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Cantidad Ba&ntilde;o</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Comentario</div>
        </td>
        <td>
            <div align="center" class="Estilo1">Imagen</div>
        </td>
        <td>
    ...
    while ($row_todas = mysql_fetch_array($_pagi_result)) {
        ...
        <tr bgcolor="<?php echo $color; ?>">
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['id_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['ciud_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['dire_inmueble']; ?></div>
            </td>
            <td><span class="Estilo1"><?php echo $row_todas['tipo_inmueble']; ?></span></td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['medio_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['dorm_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['banio_inmueble']; ?></div>
            </td>
            <td align="justify">
                <div align="center" class="Estilo1"><?php echo $row_todas['comentario_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['imagen_inmueble']; ?></div>
            </td>
            <td>
                <div align="center" class="Estilo1"><?php echo $row_todas['fecha_inmueble']; ?></div>
            </td>
            <td>
                <div align="center"><a
                        href="ver_inmuebles.php?id_inmueble=<?php echo $row_todas['id_inmueble']; ?>"><img
                            src="images/modificar.gif" alt="Modificar" width="20" height="20" border="0"/></a><a
                        href="registro_bd.php?id_inmueble=<?php echo $row_todas['id_inmueble']; ?>&amp;eliminar=1"><img
