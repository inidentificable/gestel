  ...
  <center>
		<table width="44%" border="0" cellpadding="0" cellspacing="2" background="../imagenes/fond.JPG">
		  ...
		  <tr>
			...
			<td><label>
				<div align="left">
				  <input name="frm_nombre" type="text" id="frm_nombre" onBlur="validacion_id_clipro_usu(document.form1.frm_id_clipro.value)"/>
				</div>
			  </label></td>
		  </tr>
		  <tr>
	...
	<table width="89%" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#0033FF">
	  ...
	  <tr bgcolor="<?php echo $color;?>">
		...
		<td><div align="center"><a href="ver_cliproveedor.php?id_clipro=<?php echo $row_todas['id_clipro'];?>"><img src="images/modificar.gif"  alt="Modificar" width="20" height="20" border="0" /></a><a href="registro_bd.php?id_clipro=<?php echo $row_todas['id_clipro'];?>&amp;eliminar=1"><img src="images/eliminar.gif" alt="Eliminar" width="20" height="20"></a></div></td>
	  </tr>
