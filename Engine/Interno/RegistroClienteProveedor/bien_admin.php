        ...
        <div id="page">
            <div class="container" align="center">
                <table width="29%" border="1" align="center">
                    <tr>
                        <td width="47%"><p><a href="ver_inmuebles.php"><img src="images/ico08.png" alt="" width="173"
                                                                            height="213"></a></p></td>
                        <td width="53%"><p><a href="ver_cliproveedor.php"><img src="images/ico09.png" alt="" width="173"
                                                                               height="213" border="0"></a></p></td>
