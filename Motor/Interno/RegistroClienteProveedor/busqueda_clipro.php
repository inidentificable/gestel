	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="page">
				...
				<div align="left"> Ud. se encuentra en: <a href="index.php">Inicio </a>&gt; <a href="bien_admin.php"> Acceso a M&oacute;dulos </a>&gt; <a href="ver_cliproveedor.php"> Módulo Cliente Proveedor</a> &gt;<a href="#"> Búqueda</a></div><br />
					<form action="" method="post" id="buscador">
						  <p><br />
						    <img src="images/busca.jpg" alt="buscar" width="58" height="65" />Buscar por RUT
						  :
							  <input type="text" name="busca_rut" value="<?php echo $registros['rut_clipro'];?>"  />
					  </p>
						  <p><br /><input type="submit" name="Buscar" id="Buscar" value="Buscar" /></p>
					</form>
							<form action="" method="post" id="form1">
							  <table border="1" cellpadding="2" cellspacing="3">
							   <tr>
								  <td>
								  <?php
										$busqueda= $_POST['busca_rut'];
										$buscar= $_POST['Buscar'];
											if($_POST['Buscar']=='Buscar'){
										$consulta ="SELECT * FROM  cliente WHERE rut_clipro  LIKE '%$busca_rut%'";
										$resultado=mysql_query($consulta);
										$contador = mysql_num_rows($resultado);
										if($contador==0){
											print'No se encontró el Rut ingresado';
										...
										print '<tr>';
   											 print '<td bgcolor="#8AD3F1"><div align="center">Id</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">RUT</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">Nombres</div></td>';
											 ...
											 print '<td bgcolor="#8AD3F1"><div align="center">E-mail</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">Dirección</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">Ciudad</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">Fecha</div></td>';
											 print '<td bgcolor="#8AD3F1"><div align="center">Documento</div></td>';											 
											 print '<td bgcolor="#8AD3F1"><div align="center">Accion</div></td>';
 										print ' </tr>';
										print '<tr>
