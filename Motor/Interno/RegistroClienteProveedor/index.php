	...
	<body class="homepage">
		<div id="header-wrapper">
			...
			<div class="row">
				<div id="banner" class="12u">
					<div class="container"><div id="slider1_container" style="position: relative; width: 600px; height: 300px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
            ...
            <div>
                ...
                <div u=caption t="*" class="captionTurquesa"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Tú casa soñada
                </div>
            </div>
            <div>
