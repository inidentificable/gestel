...
class Template
{
    ...
    function tpl_test($tpl)
    {
        ...
        ob_start();
        include_once DireccionTemplate . $tpl . '.php';
    ...
    function tpl_prefs_nav()
    {
        ...
        $this->pref_nav['view'] = array(
            'pref' => '<strong>' . $OBJ->lang->word('view Sitio') . '</strong>', 'link' => BASEURL . '/', 'attr' => "class='prefs'");
