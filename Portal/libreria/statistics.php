...
class Statistics
{
    ...
    function stat_doStats()
    {
        ...
        $stat['Lenguaje'] = $this->stat_getLanguage($_SERVER['HTTP_ACCEPT_LANGUAGE']);
    ...
    /**
     * Returns string
     * (to avoid our own Sitio from referrer stats)
     *
     * @param string $input
     * @return string
     */
    ...
    function stat_insertHit()
    {
        ...
        // ignore ip's listed in the Configuracion file
