...
class Media
{
    ...
    /**
     * Returns allowed uploads (filetypes from Configuracion.php) array and max size
     *
     * @param void
     * @return mixed
     */
    ...
    /**
     * Returns new file name based upon exiting Archivos to prevent name collisions
     *
