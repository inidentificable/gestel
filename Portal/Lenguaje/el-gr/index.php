...
// error messages
    ...
    'router err 1' => 'Αυτό το Modulos/σελίδα δεν υπάρχει.',
...
// generic forms parts & labels
    ...
    'attach more Archivos' => 'Προσθήκη Περισσότερων Αρχείων',
...
// editor buttons & such
    ...
    'Archivos manager' => 'Διαχείριση Αρχείων',
...
// popup editor parts
    ...
    "upload Archivos" => "Αποστολή Αρχείων",
...
// installation
    ...
    'htaccess not ok' => "Ορίστε το 'MODREWRITE' σε 'false' στο Configuracion.php...",
    'Archivos ok' => "ο φάκελος /Archivos είναι εγγράψιμος...",
    'Archivos not ok' => "ο φάκελος /Archivos δεν είναι εγγράψιμος...",
    'filesgimgs ok' => "ο φάκελος /Archivos/gimgs είναι εγγράψιμος...",
    'filesgimgs not ok' => "ο φάκελος /Archivos/gimgs δεν είναι εγγράψιμος...",
    'try BaseDatos setup now' => "Ας προσπαθήσουμε τώρα να εγκαταστήσουμε την βάση δεδομένων.",
    'continue' => "Συνέχεια",
    ...
    'edit Configuracion' => "Απαιτείται επεξεργασία του αρχείου Configuracion.php με τις κατάλληλες ρυθμίσεις της βάσης δεδομένων.",
    ...
    'check Configuracion' => "Παρακαλώ ελέγξτε τις ρυθμίσεις (Configuracion settings) ξανά.",
...
// additions 18.03.2007
    ...
    'cancel' => 'Άκυρο',
    'view Sitio' => 'Προβολή Ιστότοπου',
    'store' => 'Store',

// additions 19.03.2007
    'Configuracion ok' => "ο φάκελος /Portal/Configuracion είναι εγγράψιμος...",
    'Configuracion not ok' => "ο φάκελος /Portal/Configuracion δεν είναι εγγράψιμος...",
...
// additions 10.04.2007
    ...
    'about this Sitio' => "Σχετικά με αυτό τον Ιστότοπο...",
