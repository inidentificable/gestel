...
(
    ...
    'Archivos ok' => "/Archivos 文件夹可写入...",
    'Archivos not ok' => "/Archivos 文件夹不可写入...",
    'filesgimgs ok' => "/Archivos/gimgs 文件夹可写入...",
    'filesgimgs not ok' => "/Archivos/gimgs 文件夹不可写入...",
    'try BaseDatos setup now' => "现在建立数据库",
    'continue' => "继续",
    'please correct errors' => "请更正以上错误",
    'refresh page' => "然后刷新本页面",
    'goto forum' => "请前往<a href='http://www.indexhibit.org/forum/'>帮助论坛</a> 获取帮助.",
    'edit Configuracion' => "您需要合适的数据库设置来对config.php文件进行编辑",
    ...
    'check Configuracion' => "请再次检查您的config设置",
    ...
    'Configuracion ok' => "/Portal/Configuracion 文件夹可写入...",
    'Configuracion not ok' => "/Portal/Configuracion 文件夹不可写入...",
