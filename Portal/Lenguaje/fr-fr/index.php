...
(
    ...
    "router err 1" => "Ce Modulos/page n'existe pas.",
    ...
    "attach more Archivos" => "Attacher d'autres fichiers",
    ...
    "Archivos manager" => "Gestion de fichiers",
    ...
    "upload Archivos" => "Téléchargement de fichiers",
    ...
    "htaccess not ok" => "Régler 'MODREWRITE' sur 'false' dans Configuracion.php...",
    "Archivos ok" => "Le directoire /Archivos est ok ...",
    "Archivos not ok" => "Les permissions du directoire /Archivos sont incorrectes ...",
    "filesgimgs ok" => "Le directoire /Archivos/gimgs folder est ok...",
    "filesgimgs not ok" => "Les permissions du directoire /Archivos/gimgs folder sont incorrectes...",
    "try BaseDatos setup now" => "Maintenant, nous créons la base de données.",
    "continue" => "Continuer",
    ...
    "edit Configuracion" => "Vous devez éditer le fichier Configuracion.php avec les réglages appropriés de la base de donnés.",
    ...
    "check Configuracion" => "Veuillez vérifier vos réglages Configuracion.",
    "default login" => "le login / mot de passe par défaut est index1 / exhibit.",
    "change settings" => "Changez ceux-ci et les réglages de votre Sitio quand vous serez connectés",
    ...
    'cancel' => 'Annuler',
    'view Sitio' => 'Voir ta page',
    'store' => 'Magasin',

    // additions 19.03.2007
    'Configuracion ok' => "le dossier /Portal/Configuracion est modifiable...",
    'Configuracion not ok' => "le dossier /Portal/Configuracion n'est pas modifiable...",
    ...
    'about this Sitio' => "À propos de ce Sitio",
