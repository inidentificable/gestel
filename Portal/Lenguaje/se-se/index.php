...
(
    ...
    'attach more Archivos' => 'Lägg till flera bilder',
    ...
    "upload Archivos" => "Ladda upp filer",
    ...
    'htaccess not ok' => "Sätt 'MODREWRITE' till 'false' i Configuracion.php...",
    'Archivos ok' => "mappen /Archivos är skrivbar...",
    'Archivos not ok' => "mappen /Archivos är inte skrivbar...",
    'filesgimgs ok' => "mappen /Archivos/gimgs är skrivbar...",
    'filesgimgs not ok' => "mappen /Archivos/gimgs är inte skrivbar...",
    'try BaseDatos setup now' => "Låt oss försöka sätta upp databasen nu.",
    'continue' => "Fortsätt",
    ...
    'edit Configuracion' => "Du måste ändra i filen Configuracion.php, så att databasinställningarna blir rätt.",
    ...
    'check Configuracion' => "Var vänlig undersök inställningarna igen.",
    ...
    'cancel' => 'Avbryt',
    'view Sitio' => 'Visa din sida',
    'store' => 'Spara',

    // additions 19.03.2007
    'Configuracion ok' => "mappen /Portal/Configuracion är skrivbar...",
    'Configuracion not ok' => "mappen /Portal/Configuracion är inte skrivbar...",
    ...
    'about this Sitio' => "Om den här webbplatsen",
