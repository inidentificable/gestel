...
(
    ...
    'attach more Archivos' => 'Mehr Dateien anfuegen',
    ...
    'Archivos manager' => 'Datei Manager',
    ...
    "upload Archivos" => "Dateien hochladen",
    ...
    'htaccess not ok' => "'MODREWRITE' in Configuracion.php auf 'falsch' setzen...",
    'Archivos ok' => "/Archivos Ordner sind beschreibbar...",
    'Archivos not ok' => "/Archivos Ordner sind nicht beschreibbar...",
    'filesgimgs ok' => "/Archivos/gimgs Ordner sind beschreibbar...",
    'filesgimgs not ok' => "/Archivos/gimgs Ordner sind nicht beschreibbar...",
    'try BaseDatos setup now' => "Datenbank jetzt einrichten.",
    'continue' => "Weiter",
    ...
    'edit Configuracion' => "Sie muessen die Configuracion.php Datei mit den neuen Daten aus der Datenbank 				  auffrischen.",
    ...
    'check Configuracion' => "Bitte ueberpruefen Sie die Einstellungen der Datei Configuracion.php.",
    ...
    'cancel' => 'Abbrechen',
    'view Sitio' => 'Seite anzeigen',
    'store' => 'Geschäft',

    // additions 19.03.2007
    'Configuracion ok' => "/Portal/Configuracion Ordner sind beschreibbar...",
    'Configuracion not ok' => "/Portal/Configuracion Ordner sind nicht beschreibbar...",
    ...
    'about this Sitio' => "About This Site",
    ...
    'about this Sitio' => "Ueber diese Seite",
