...
(
    ...
    'router err 1' => 'Die Modulos/pagina bestaat niet.',
    ...
    'attach more Archivos' => 'Voeg meer bestanden toe',
    ...
    'Archivos manager' => 'Beheerder voor bestanden',
    ...
    "upload Archivos" => "Laad bestanden op",
    ...
    'htaccess not ok' => "Zet 'MODREWRITE' op 'false' in Configuracion.php...",
    'Archivos ok' => "/Archivos folder is beschrijfbaar...",
    'Archivos not ok' => "/Archivos folder is niet beschrijfbaar...",
    'filesgimgs ok' => "/Archivos/gimgs folder is beschrijfbaar...",
    'filesgimgs not ok' => "/Archivos/gimgs folder is niet beschrijfbaar...",
    'try BaseDatos setup now' => "Laten we nu proberen de databank in te stellen.",
    'continue' => "Ga verder",
    ...
    'edit Configuracion' => "Je moet het Configuracion.php bestand aanpassen met de correcte databank instellingen.",
    ...
    'check Configuracion' => "Controleer de configuratie-instellingen nogmaals a.u.b..",
    ...
    'cancel' => 'Annuleer',
    'view Sitio' => 'Bekijk', // still need this one
    'store' => 'Winkel',

    // additions 19.03.2007
    'Configuracion ok' => "/Portal/Configuracion folder is beschrijfbaar...",
    'Configuracion not ok' => "/Portal/Configuracion folder is niet beschrijfbaar...",
    ...
    'about this Sitio' => "Over deze Sitio",
