...
(
    ...
    'attach more Archivos' => 'Adjuntar més fitxers',
    ...
    'Archivos manager' => 'Gestió de fitxers',
    ...
    'htaccess not ok' => "Configura 'MODREWRITE' en 'false' a Configuracion.php...",
    'Archivos ok' => "La carpeta /Archivos s\'ha instal·lat correctament...",
    'Archivos not ok' => "Els permisos de la carpeta /Archivos són incorrectes...",
    'filesgimgs ok' => "La carpeta /Archivos/gimgs  s\'ha instal·lat correctament...",
    'filesgimgs not ok' => "Els permisos de la carpeta /Archivos/gimgs són incorrectes...",
    'try BaseDatos setup now' => "Ara anem a configurar la base de dades.",
    'continue' => "Continua",
    ...
    'edit Configuracion' => "Tens que editar el teu fitxer Configuracion.php file amb la configuració adequada de la base de dades.",
    ...
    'check Configuracion' => "Comproba la configuració de Configuracion de nou, si us plau.",
    ...
    'cancel' => 'Cancel·lar',
    'view Sitio' => 'Veure la teva pàgina',
    'store' => 'Botiga',

    // additions 19.03.2007
    'Configuracion ok' => "La carpeta /Portal/Configuracion es pot modificar...",
    'Configuracion not ok' => "La carpeta /Portal/Configuracion no es pot modificar...",
    ...
    'about this Sitio' => "Sobre aquesta pàgina",
