...
(
    ...
    'attach more Archivos' => 'Присоединить еще файлы',
    ...
    'Archivos manager' => 'Менеджер файлов',
    ...
    "upload Archivos" => "Загрузить файлы",
    ...
    'htaccess not ok' => "Установите значение 'MODREWRITE' на 'false' в Configuracion.php...",
    'Archivos ok' => "папка /Archivos доступна для записи...",
    'Archivos not ok' => "папка /Archivos недоступна для записи...",
    'filesgimgs ok' => "папка /Archivos/gimgs доступна для записи...",
    'filesgimgs not ok' => "папка /Archivos/gimgs недоступна для записи...",
    'try BaseDatos setup now' => "Теперь попробуем установить базу данных.",
    'continue' => "Продолжить",
    ...
    'edit Configuracion' => "Вам необходимо отредактировать файл Configuracion.php с надлежащими настройками базы данных.",
    ...
    'check Configuracion' => "Пожалуйста проверьте свои настройки конфигурации снова.",
    ...
    'cancel' => 'Отменить',
    'view Sitio' => 'Посмотреть на сайт',
    'store' => 'Магазин',

    // additions 19.03.2007
    'Configuracion ok' => "папка /Portal/Configuracion доступна для записи...",
    'Configuracion not ok' => "папка /Portal/Configuracion folder недоступна для записи...",
