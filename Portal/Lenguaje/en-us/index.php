...
(
    ...
    'router err 1' => 'That Modulos/page does not exist.',
    ...
    'attach more Archivos' => 'Attach More Files',
    ...
    'Archivos manager' => 'Files Manager',
    ...
    'htaccess not ok' => "Set 'MODREWRITE' to 'false' in Configuracion.php...",
    'Archivos ok' => "/Archivos folder is writable...",
    'Archivos not ok' => "/Archivos folder is not writable...",
    'filesgimgs ok' => "/Archivos/gimgs folder is writable...",
    'filesgimgs not ok' => "/Archivos/gimgs folder is not writable...",
    'try BaseDatos setup now' => "Let's try to set up the database now.",
    'continue' => "Continue",
    ...
    'edit Configuracion' => "You need to edit your Configuracion.php file with the proper database settings.",
    ...
    'check Configuracion' => "Please check your Configuracion settings again.",
    'default login' => "The default login / password is index1 / exhibit.",
    'change settings' => "Change these and your Sitio settings once inside.",
    ...
    'cancel' => 'Cancel',
    'view Sitio' => 'View Your Site',
    'store' => 'Store',

    // additions 19.03.2007
    'Configuracion ok' => "/Portal/Configuracion folder is writable...",
    'Configuracion not ok' => "/Portal/Configuracion folder is not writable...",
