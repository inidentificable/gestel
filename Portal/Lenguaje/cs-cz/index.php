...
(
    ...
    'attach more Archivos' => 'Připojit další soubory',
    ...
    'Archivos manager' => 'Manažer souborù',
    ...
    "upload Archivos" => "Nahrát soubory na server",
    ...
    'htaccess not ok' => "Nastavte 'MODREWRITE' na 'false' v Configuracion.php...",
    'Archivos ok' => "Do adresáře /Archivos lze zapisovat...",
    'Archivos not ok' => "Do adresáře /Archivos nelze zapisovat...",
    'filesgimgs ok' => "Do adresáře /Archivos/gimgs lze zapisovat...",
    'filesgimgs not ok' => "Do adresáře /Archivos/gimgs nelze zapisovat...",
    'try BaseDatos setup now' => "Nyní zkusme nastavit databázi.",
    'continue' => "Pokračovat",
    ...
    'edit Configuracion' => "Je nutné upravit soubor Configuracion.php a doplnit správné nastavení databáze.",
    ...
    'check Configuracion' => "Znovu prosím zkontrolujte nastavení konfigurace.",
    ...
    'cancel' => 'Zrušit',
    'view Sitio' => 'Ukázat stránku',
    'store' => 'Uskladnit',

    // additions 19.03.2007
    'Configuracion ok' => "Do adresáře /Portal/Configuracion lze zapisovat...",
    'Configuracion not ok' => "Do adresáře /Portal/Configuracion nelze zapisovat...",
    ...
    'about this Sitio' => "O této stránce",
