...
(
    ...
    'attach more Archivos' => 'Lis&auml;&auml; tiedosto',
    ...
    'Archivos manager' => 'Tiedostojen hallinta',
    ...
    "upload Archivos" => "Ladatut tiedostot",
    ...
    'htaccess not ok' => "Aseta 'MODREWRITE' arvoksi 'false' tiedostossa Configuracion.php...",
    'Archivos ok' => "/tiedosto kansioon voi kirjoittaa...",
    'Archivos not ok' => "/tiedosto kansioon EI voi kirjoittaa...",
    'filesgimgs ok' => "/Archivos/gimgs kansioon voi kirjoittaa...",
    'filesgimgs not ok' => "/Archivos/gimgs kansioon EI voi kirjoittaa...",
    'try BaseDatos setup now' => "Tietokannan asetuksia kokeillaan.",
    'continue' => "Jatka",
    ...
    'edit Configuracion' => "Editoi Configuracion.php tiedostoa oikeilla tietokannan asetuksilla.",
    ...
    'check Configuracion' => "Tarkista asetuksesi uudelleen.",
    ...
    'cancel' => 'Peruuta',
    'view Sitio' => 'N&auml;yt&auml; oma sivu',
    'store' => 'Varastoi',

    // additions 19.03.2007
    'Configuracion ok' => "/Portal/Configuracion kansioon voi kirjoittaa...",
    'Configuracion not ok' => "/Portal/Configuracion kansioon EI voi kirjoittaa...",
    ...
    'about this Sitio' => "T&auml;st&auml; sivustosta",
