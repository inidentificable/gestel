...
function getFiles()
{
	...
	else
	{
		foreach ($rs as $a) 
		{
			...
			$edit = span(href("<img src='asset/img/Archivos-edit.gif' />",
...
function filesManagerType($type, $file, $x='', $y='', $desc='')
{
	...
	{
		return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsImg('". BASEURL . '/Archivos/' . $file ."','$x','$y');return false;\"");
	}
	// mp3, mov, etc...
	elseif (in_array($type, $uploads['media']))
	{
		switch ($type) {
		case 'mp3':
		   return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsMP3('". BASEURL . '/Archivos/' . $file ."');return false;\"");
		   break;
		case 'mov':
		   return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsMov('". BASEURL . '/Archivos/' . $file ."','$x','$y');return false;\"");
		   break;
		// not in use...
		case 'avi':
		   return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsAVI('". BASEURL . '/Archivos/' . $file ."','$x','$y');return false;\"");
		   break;
		case 'jar':
		   return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsJAR('". BASEURL . '/Archivos/' . $file ."','$x','$y');return false;\"");
		   break;
		}
	}
	// flash
	...
	{
		return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsFlash('". BASEURL . '/Archivos/' . $file ."','$x','$y');return false;\"");
	}
	// other Archivos
	else
	{
		return href("<img src='asset/img/Archivos-use.gif' />", '#', "onClick=\"ModInsFile('". BASEURL . '/Archivos/' . $file ."','$desc');return false;\"");
	}	
}
